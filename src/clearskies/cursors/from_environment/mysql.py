...
class Mysql(MysqlBase):
    ...
    This class provides a MySQL cursor implementation that reads connection parameters
    from environment variables, making it easy to configure for different environments.
    It supports all features of the base [`Mysql`](src/clearskies/cursors/mysql.py:1) class,
