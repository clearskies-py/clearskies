...
class SshCert(port_forwarder.PortForwarder):
    """
    ...
    - `cert_path` (str): Path to the SSH certificate file (required)
    ...
    """
    cert_path = clearskies.configs.String()
    ...
    def setup(self, original_host: str, original_port: int) -> tuple[str, int]:
        ...
        # Check if the port is already open (tunnel already established)
